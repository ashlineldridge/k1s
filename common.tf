locals {
  ...
  kube_api_private_domain = "kube-api.${local.zone_name}"
  kube_api_port           = 6443
  kube_api_private_url    = "https://${local.kube_api_private_domain}:${local.kube_api_port}"
  kube_api_localhost_url  = "https://127.0.0.1:${local.kube_api_port}"
}
